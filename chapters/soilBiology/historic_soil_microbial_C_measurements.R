...
dt1 <- get_edi_table(identifier = "67", entity_seq = 1)
...
p_microC <- ggplotly(microC) %>%
  layout(
    title = list(
      text = "Microbial Biomass Carbon",
      x = 0.5,
      xanchor = "center",
...
output_file <- "MicrobialBiomassCarbon.html"
...
webshot2::webshot(output_file, file ="MicrobialBiomassCarbon.png" , delay = 2)
...
p_microN <- ggplotly(microN) %>%
  layout(
    title = list(
      text = "Microbial Biomass Nitrogen",
      x = 0.5,
      xanchor = "center",
      font = list(size = 24, color = "black")
    ),
...
output_file <- "MicrobialBiomassNitrogen.html"
fname <- tools::file_path_sans_ext(basename(output_file))
...
# Save static PNG from the HTML
Sys.setenv(CHROMOTE_CHROME = "/usr/bin/chromium-browser")  # adjust path
webshot2::webshot(output_file, file ="MicrobialBiomassNitrogen.png" , delay = 2)
...
microCN
p_microN <- ggplotly(microCN) %>%
  layout(
    title = list(
      text = "Microbial Biomass C:N Ratio",
      x = 0.5,
      xanchor = "center",
      font = list(size = 24, color = "black")
    ),
...
output_file <- "MicrobialBiomassCN.html"
fname <- tools::file_path_sans_ext(basename(output_file))
...
# Save static PNG from the HTML
Sys.setenv(CHROMOTE_CHROME = "/usr/bin/chromium-browser")  # adjust path
webshot2::webshot(output_file, file ="MicrobialBiomassCN.png" , delay = 2)
...
p_microresp <- ggplotly(microresp) %>%
  layout(
    title = list(
      text = "Microbial Biomass Respiration",
      x = 0.5,
      xanchor = "center",
      font = list(size = 24, color = "black")
    ),
...
output_file <- "MicrobialBiomassRespiration.html"
fname <- tools::file_path_sans_ext(basename(output_file))
...
# Save static PNG from the HTML
Sys.setenv(CHROMOTE_CHROME = "/usr/bin/chromium-browser")  # adjust path
webshot2::webshot(output_file, file ="MicrobialBiomassRespiration.png" , delay = 2)
...
p_microdea <- ggplotly(microdea) %>%
  layout(
    title = list(
      text = "Microbial Biomass Denitrification Enzyme Activity",
      x = 0.5,
      xanchor = "center",
      font = list(size = 24, color = "black")
    ),
...
output_file <- "MicrobialBiomassDEA.html"
fname <- tools::file_path_sans_ext(basename(output_file))
...
# Save static PNG from the HTML
Sys.setenv(CHROMOTE_CHROME = "/usr/bin/chromium-browser")  # adjust path
webshot2::webshot(output_file, file ="MicrobialBiomassDEA.png" , delay = 2)
...
p_microdeabioc <- ggplotly(microdeabioc) %>%
  layout(
    title = list(
      text = "Microbial Biomass DEA:Carbon",
      x = 0.5,
      xanchor = "center",
      font = list(size = 24, color = "black")
    ),
...
output_file <- "MicrobialBiomassDEABIOC.html"
fname <- tools::file_path_sans_ext(basename(output_file))
...
# Save static PNG from the HTML
Sys.setenv(CHROMOTE_CHROME = "/usr/bin/chromium-browser")  # adjust path
webshot2::webshot(output_file, file ="MicrobialBiomassDEABIOC.png" , delay = 2)
