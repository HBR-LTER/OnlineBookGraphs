...
p2<-ggplotly(g2)%>%
  layout(margin=m)
p2 <- p2 %>%
       layout(legend = list(orientation = "v", x = 0.7, y = .7))
...
htmlwidgets::saveWidget(as_widget(p2), "Fig5A_organicMatter.html")
htmlwidgets::saveWidget(as_widget(p3), "Fig5B_organicMatter.html")
